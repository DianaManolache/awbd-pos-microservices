 ...
 * iesire (catre Sales Service), astfel ca celalalt serviciu vede acelasi
 * utilizator/rol care a declansat cererea originala. Daca nu exista o
 * cerere curenta, genereaza un token de sistem (nu ar trebui sa se
 * intample in acest serviciu, dar evita un apel Feign fara header deloc).
 */
@Component
