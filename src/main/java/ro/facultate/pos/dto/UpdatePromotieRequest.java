...
@Schema(description = "Request pentru actualizare promotie")
public class UpdatePromotieRequest {
    ...
    @Schema(description = "Promotie activa sau dezactivata")
    @NotNull
    private Boolean activa;

    public UpdatePromotieRequest() {}
