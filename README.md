...
**Aplicatia e live la** [http://74.248.120.248:8080](http://74.248.120.248:8080) (VM Azure, pornit doar cand e nevoie de demo - vezi comenzile de start/stop mai jos). Login cu contul ADMIN implicit: `admin` / `admin123`.
