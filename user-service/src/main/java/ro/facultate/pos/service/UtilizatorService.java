...
public class UtilizatorService {
    ...
    public UtilizatorService(UtilizatorRepository utilizatorRepository, SalesClient salesClient,
    ...
    public Utilizator create(CreateUtilizatorRequest req) {
        ...
        VanzatorResponse vanzator = salesClient.getVanzator(req.getVanzatorId());
        if (vanzator == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Vanzator not found");
        }
        ...
        u.setRol(req.getRol());
        u.setActiv(true);
        u.setVanzatorId(req.getVanzatorId());
    ...
    public boolean existaUtilizatorPentruVanzator(Long vanzatorId) {
        return utilizatorRepository.findByVanzatorId(vanzatorId).isPresent();
    }
}
